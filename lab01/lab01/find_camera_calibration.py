...
while True:
    ...
    ret, corners = cv2.findChessboardCorners(
        gray, (CHECKERBOARD_COL, CHECKERBOARD_ROW), None)
    ...
    if ret == True:
        ...
        frame = cv2.drawChessboardCorners(
            frame, (CHECKERBOARD_COL, CHECKERBOARD_ROW), refined_corners, ret)
...
ret, camera_matrix, distortion_coeff, rvec, tvec = cv2.calibrateCamera(
